      ...
      <div className="mx-auto grid max-w-7xl lg:grid-cols-2">
        ...
        <div className="flex flex-col justify-center px-6 py-16 sm:px-12 lg:px-16">
          ...
          <h2 className="font-display mt-4 max-w-xl text-3xl font-bold text-white sm:text-4xl">
            Appoint us for your next port call
          </h2>
          <p className="mt-5 max-w-lg text-base leading-relaxed text-white/70">
            From agency formalities, crew change, and spares to protective
            attendance and oil and gas upstream support — we coordinate the full
            port call around your ETA/ETD.
          </p>
          <Link
            href="/corporate"
